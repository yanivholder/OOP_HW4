...
public class Cases {
    ...
    /************************************************************************/
    static final int ctorInt = 0;
    static final int copyCtorInt = 1;
    static final int beforeInt = 2;
    static final int afterInt = 3;
    ...
    public static class testCopyCtorClass {
        ...
        public void beforeTest2() throws Exception {
            hasCopyCtor_int.publicInt = beforeInt;
            throw new Exception();
        }

        @OOPAfter({"test4"})
        public void afterTest4() throws Exception {
            hasCopyCtor_int.publicInt = afterInt;
            throw new Exception();
        }
        ...
        @OOPTest(order = 1)
        public void test1() {
            OOPUnitCore.assertEquals(hasCopyCtor_int.publicInt, ctorInt);
        }
        ...
        @OOPTest(order = 3)
        public void test3() {
            OOPUnitCore.assertEquals(hasCopyCtor_int.publicInt, copyCtorInt);
        }
